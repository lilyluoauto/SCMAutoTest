...
public class RedisStudy {
  ...
  //      initialConn();
    ...
    private void initialConn(){
        jedis = new Jedis("192.168.0.133", 6379);
      //  jedis.auth("root");
    }
    ...
    private void initialPool()
    {
       ...
       // config.setMaxActive(20);
        ...
        jedisPool = new JedisPool(config,"192.168.0.133",6379);
    }
    ...
    private void initialShardedPool()
    {
       ...
       // config.setMaxActive(20);
        ...
        shards.add(new JedisShardInfo("192.168.0.133", 6379, "master"));
